(() => {
  ...
  const LEVELS = [
    { name: "1990 意大利·罗马斗兽场", flags: ["🇮🇹"], hosts: "意大利", badge: { icon: "🏛️", motif: "🌿", title: "罗马斗兽场", detail: "永恒之城·桂冠" }, scene: "italy90", difficulty: "轻松", routes: { main: "罗马地标主线", forest: "罗马历史街区", beach: "罗马城市广场", snow: "罗马球迷庆典" }, width: 3000, gaps: [90, 105, 110], enemies: 4, speed: 65, sky: ["#5fc8ff", "#ffe3a8"], top: "#8bcf63", base: "#b97648", edge: "#5d3929", accent: "#d94a3a" },
    { name: "1994 美国·玫瑰碗", flags: ["🇺🇸"], hosts: "美国", badge: { icon: "🌹", motif: "🏟️", title: "玫瑰碗", detail: "帕萨迪纳·玫瑰" }, scene: "usa94", difficulty: "简单", routes: { main: "帕萨迪纳地标主线", forest: "帕萨迪纳历史街区", beach: "帕萨迪纳城市广场", snow: "帕萨迪纳球迷庆典" }, width: 3250, gaps: [105, 115, 120, 110], enemies: 5, speed: 72, sky: ["#4dbcf4", "#f9d8a7"], top: "#66c864", base: "#a56a43", edge: "#4f3429", accent: "#e94848" },
    { name: "1998 法国·巴黎铁塔", flags: ["🇫🇷"], hosts: "法国", badge: { icon: "🗼", motif: "⚜️", title: "巴黎铁塔", detail: "法兰西·鸢尾纹章" }, scene: "france98", difficulty: "简单+", routes: { main: "巴黎地标主线", forest: "巴黎历史街区", beach: "巴黎城市广场", snow: "巴黎球迷庆典" }, width: 3450, gaps: [110, 125, 120, 130], enemies: 6, speed: 78, sky: ["#6e9bd7", "#ffd9b7"], top: "#8bcf68", base: "#b87b58", edge: "#55413b", accent: "#f0c84b" },
    { name: "2002 韩日·横滨港", flags: ["🇰🇷", "🇯🇵"], hosts: "韩国、日本", badge: { icon: "⚓", motif: "🌸", title: "横滨港", detail: "双城港湾·樱花" }, scene: "koreajapan02", difficulty: "普通", routes: { main: "横滨港地标主线", forest: "首尔历史街区", beach: "横滨城市广场", snow: "首尔球迷庆典" }, width: 3650, gaps: [120, 135, 125, 145, 120], enemies: 7, speed: 84, sky: ["#57c2ee", "#f1d3dc"], top: "#67c6aa", base: "#4e8195", edge: "#234b61", accent: "#ef586c" },
    { name: "2006 德国·勃兰登堡门", flags: ["🇩🇪"], hosts: "德国", badge: { icon: "🏛️", motif: "🐻", title: "勃兰登堡门", detail: "柏林之门·城市熊" }, scene: "germany06", difficulty: "普通", routes: { main: "柏林地标主线", forest: "柏林历史街区", beach: "柏林城市广场", snow: "柏林球迷庆典" }, width: 3850, gaps: [125, 140, 135, 150, 130], enemies: 8, speed: 90, sky: ["#6baad8", "#dce9f3"], top: "#71c86b", base: "#8d8272", edge: "#3c3a38", accent: "#f3ca3b" },
    { name: "2010 南非·开普桌山", flags: ["🇿🇦"], hosts: "南非", badge: { icon: "⛰️", motif: "🌺", title: "开普桌山", detail: "彩虹之国·帝王花" }, scene: "southafrica10", difficulty: "进阶", routes: { main: "开普敦地标主线", forest: "开普敦历史街区", beach: "开普敦城市广场", snow: "开普敦球迷庆典" }, width: 4050, gaps: [135, 145, 155, 140, 160], enemies: 8, speed: 98, sky: ["#4dc8ee", "#ffd68d"], top: "#76bd5c", base: "#9e6c3e", edge: "#453629", accent: "#f4bd34" },
    { name: "2014 巴西·里约热内卢", flags: ["🇧🇷"], hosts: "巴西", badge: { icon: "🙌", motif: "🌴", title: "里约热内卢", detail: "基督山·热带棕榈" }, scene: "brazil14", difficulty: "进阶+", routes: { main: "里约地标主线", forest: "里约历史街区", beach: "里约城市广场", snow: "里约球迷庆典" }, width: 4250, gaps: [140, 155, 150, 165, 145, 160], enemies: 9, speed: 104, sky: ["#3bc5ef", "#ffe59d"], top: "#65c951", base: "#ad7745", edge: "#4c3927", accent: "#f6d13c" },
    { name: "2018 俄罗斯·圣瓦西里", flags: ["🇷🇺"], hosts: "俄罗斯", badge: { icon: "🏰", motif: "❄️", title: "圣瓦西里", detail: "莫斯科·雪花穹顶" }, scene: "russia18", difficulty: "困难", routes: { main: "莫斯科地标主线", forest: "莫斯科历史街区", beach: "莫斯科红场", snow: "莫斯科球迷庆典" }, width: 4450, gaps: [150, 165, 155, 170, 160, 175], enemies: 10, speed: 110, sky: ["#263b77", "#e7b9c9"], top: "#d9edf3", base: "#6f7f91", edge: "#29394e", accent: "#f2ca46" },
    { name: "2022 卡塔尔·多哈海滨", flags: ["🇶🇦"], hosts: "卡塔尔", badge: { icon: "🐚", motif: "🌙", title: "多哈海滨", detail: "珍珠之城·新月" }, scene: "qatar22", difficulty: "困难+", routes: { main: "多哈地标主线", forest: "多哈历史街区", beach: "多哈海滨广场", snow: "多哈球迷庆典" }, width: 4650, gaps: [155, 170, 165, 180, 170, 185], enemies: 11, speed: 118, sky: ["#412053", "#f39c67"], top: "#e8bf67", base: "#a65f42", edge: "#4b2934", accent: "#f4e0a4" },
    { name: "2026 美加墨·联合盛典", flags: ["🇺🇸", "🇨🇦", "🇲🇽"], hosts: "美国、加拿大、墨西哥", badge: { icon: "🌎", motif: "⚽", title: "美加墨盛典", detail: "三国同心·终极之战" }, scene: "northamerica26", difficulty: "终极Boss", routes: { main: "墨西哥城·多伦多·旧金山", forest: "墨西哥城历史街区", beach: "多伦多城市广场", snow: "旧金山球迷庆典" }, width: 4900, gaps: [160, 175, 170, 185, 175, 190, 165], enemies: 12, speed: 126, sky: ["#15224f", "#6ca6dc"], top: "#68c85b", base: "#506b75", edge: "#202d3b", accent: "#ffd24f" },
  ];
