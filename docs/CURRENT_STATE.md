...
- 小罗出现频率按用户最新指令提高：完整十关旅程会在第 6–10 关保底随机抽取 3 个不同关卡，再随机增加 0–2 个不同关卡，因此每轮共出现 3–5 名；第 10 关被抽中时小罗与终极 Boss 同关出现。
...
- 小罗作为敌人；完整十关旅程在第 6–10 关保底随机 3 个、再随机增加 0–2 个不同关卡各出现一名，击败后 Neymar 保持原形并获得 4 秒桑巴冲锋。
- 当前测试对上述小罗规则、双球连射和禁止变身有明确的正向与反向断言。

## 当前待办

- 第 6–10 关小罗保底 3 次、随机增至 4–5 次的规则已通过发布前验证，等待线上发布读回。
